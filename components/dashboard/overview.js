          ...
          >
            ...
            <div className="mb-3">
              <div className={`p-2 rounded-lg h-12 flex items-center text-xs ${
                unit.user_profiles ? 'bg-white border' : 'bg-white border border-red-200'
              }`}>
                {unit.user_profiles ? (
                  <div className="flex items-center justify-between w-full">
                    <div>
                      <p className="font-medium text-gray-900">{unit.user_profiles.full_name}</p>
                    </div>
